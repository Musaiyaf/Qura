...
export const quranData: QuranData = {
  surahs: [
    ...
    },
    {
      ...
      name: "النمل",
      englishName: "An-Naml",
      englishNameTranslation: "The Ants",
      numberOfAyahs: 93,
      revelationType: "Meccan"
    },
    {
    ...
    },
    {
      ...
      englishNameTranslation: "Prohibition",
      numberOfAyahs: 12,
      revelationType: "Medinan"
    },
    {
...
// Sample verses for Al-Baqarah (first 5 verses)
export const alBaqarahVerses = [
  {
    number: 1,
    text: "الم",
...
export const getVerses = (surahNumber: number) => {
  if (surahNumber === 1) return alFatihaVerses;
  if (surahNumber === 2) return alBaqarahVerses;
  return [];
};

// Get audio URL for a specific surah
export const getAudioUrl = (surahNumber: number) => {
  // Using recitation by Mishary Rashid Alafasy
